function LinkedList(){
    ...
    this.removeAt = function(index){
        ...
        if (index === 0){
            ...
            // Or 
            // Bellow loop will check the value of nextNode
            // while (currentIndex < index){
...
console.log(ll.size());
console.log(ll.indexOf("Car"))
console.log(ll.addAt(2, "Motor Bike"));

// Circular Linked List 
// currentNode.previousNode.next = currentNode.next;
// currentNode.previousNode = currentNode.previousNode